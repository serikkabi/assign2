...
if (typeof window.ethereum !== 'undefined') {
    ...
    console.error("MetaMask does not working");
}
...
const conAddress = '0xab699567E4Fa14e0e937bD773f5dB39Cf8F5A5bc';
const conABI = [
	{
		"inputs": [],
		"name": "getOutcome",
...
const contract = new web3.eth.Contract(conABI, conAddress);
